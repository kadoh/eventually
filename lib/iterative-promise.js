...
IterativePromise.prototype = {
   ...
   *
   * @param  {Function(key)} mapFn [description]
   ...
   * reduce process.
   *
   * @param {function(previous, result, map, key, resolved, rejected)} reduceFn
   ...
   *                                multiple arguments, additional arguments ar
   *                                present
   *     @param  {function}   map - use this function to feed the mapping proce
   ...
   *     @param  {array} resolved - array of keys which mapped Promise have bee
   *                                resolved
   *     @param  {array} rejected - array of keys which mapped Promise have bee
   *                                rejected
   ...
   *
   *
   * @param  {function(reduce_result, map, resolved, rejected)} endFn
   *     @param {*} reduce_result - what finally came out the reduce process
   *     @param {function}    map - use this function to feed the mapping proces
